    ...
    >
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <a
            href="mailto:dagarpranav02@gmail.com"
          ...
          >
            ...
            <div className="text-left">
              ...
              <p className="text-slate-400">
                github.com/pranavdagar1
              </p>
            </div>
          </a>

          <a
            href="https://linkedin.com/in/pranav-dagar-904047419"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-4 bg-slate-900 border border-slate-700 rounded-xl p-6 hover:border-cyan-400 hover:-translate-y-1 transition-all"
          >
            ...
            <div className="text-left">
              ...
              <p className="text-slate-400">
                linkedin.com/in/pranav-dagar-904047419
              </p>
            </div>
          </a>
